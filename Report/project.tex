...
\section{ILASP}
\cite{MarkLaw/Thesis}\cite{MarkLaw/ILASP2}\cite{MarkLaw/OG-ILASP}\cite{ILASP-Manuel}
ILASP is an ILP system based on Answer Set Programming (ASP). An introduction to ASP can be found here \cite{Corapi/ASP}.
