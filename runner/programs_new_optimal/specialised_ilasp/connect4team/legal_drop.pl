...
legal_drop(V0, V1) :- true_cell(V3, V5, V0), V0 = orange, agent(V0), pos(V1), pos(V3), pos(V5).
legal_drop(V0, V1) :- true_cell(V3, V5, V11), V0 = cyan, agent(V0), pos(V1), pos(V3), pos(V5), agent(V11).
