...
legal_mark(149,robot,3,2,3).
legal_mark(149,robot,2,2,3).
legal_mark(149,robot,3,3,3).
legal_mark(149,robot,3,3,1).
legal_mark(149,robot,3,2,2).
legal_mark(149,robot,1,3,2).
legal_mark(150,robot,2,3,1).
legal_mark(150,robot,3,3,2).
legal_mark(150,robot,1,3,3).
legal_mark(150,robot,2,3,3).
legal_mark(150,robot,3,1,1).
legal_mark(150,robot,1,1,3).
legal_mark(150,robot,3,1,3).
legal_mark(150,robot,3,2,3).
legal_mark(150,robot,2,2,3).
legal_mark(150,robot,3,3,3).
legal_mark(150,robot,3,3,1).
legal_mark(150,robot,3,2,2).
legal_mark(150,robot,1,3,2).
legal_mark(151,robot,2,3,1).
legal_mark(151,robot,2,3,3).
legal_mark(151,robot,1,3,3).
legal_mark(151,robot,3,1,1).
legal_mark(151,robot,1,1,3).
legal_mark(151,robot,3,1,3).
legal_mark(151,robot,2,2,3).
legal_mark(151,robot,3,3,3).
legal_mark(151,robot,3,3,1).
legal_mark(151,robot,1,3,2).
legal_mark(152,robot,2,3,3).
legal_mark(152,robot,1,3,3).
legal_mark(152,robot,1,1,3).
legal_mark(152,robot,3,1,3).
legal_mark(152,robot,2,2,3).
legal_mark(152,robot,1,3,2).
